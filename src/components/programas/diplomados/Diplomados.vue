<template>
  <div v-if="showing !== 'desarrollo'" class="relative">
    ...
    <div class="flex justify-between items-center bg-white py-2 px-4 md:px-4 lg:px-20">
      <!-- Botón Izquierdo -->
    <button class="relative left-0 top-1/2 transform -translate-y-1/2 bg-[#f1efef] text-[#0A8B37] px-4 py-4 z-10 hover:bg-opacity-50 rounded-full"
      ...
      <!-- Imagen del programa -->
      <div class="w-1/4 flex justify-center items-center ml-0">
      ...
      <div class="w-3/4 bg-white border border-[#0A8B37] rounded-3xl px-0 shadow-lg ml-4 mr-6">
        <h2 class="bg-gradient-to-r from-[#1c4d59] to-[#0A8B37] text-[#ffffff] p-6 rounded-3xl rounded-b-none text-2xl font-bold text-center">
      ...
      <!-- Botón Derecho -->
    <button 
      class="relative right-0 top-1/2 transform -translate-y-1/2 bg-[#f1efef] text-[#0A8B37] px-4 py-4 z-50 hover:bg-opacity-50 rounded-full"
...
<!-- Footer -->
<footer :class="{ 'relative bottom-0 left-0 w-full h-[605px] z-50 transition duration-700 ease-in-out': showing === 'desarrollo', 'relative mt-4': showing !== 'desarrollo'}" class="bg-gradient-to-r from-[#1c4d59] to-[#0A8B37] text-white  px-4 transition-all duration-1000 ease-in-out">
...
import diplomado_desarrollo from './Diplomados_desarrollo.vue';
...
<style scoped>
/* Agrega los estilos que necesites aquí */
</style>
<style scoped>
